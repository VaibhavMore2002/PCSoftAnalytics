          ...
          {source && (
            <div className="flex items-center gap-2 shrink-0">
              ...
              <button className={btnP} style={{ background: "var(--nav-active-bg)" }}
                ...
                <I d={ico.edit} size={14} color="#fff" sw={2.5} /> Edit
              </button>
            </div>
          )}
        </header>
              ...
              {activeTab === "tables" && (
                <div className="w-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <select
                      className="bg-[var(--bg-input)] border border-[var(--border)] rounded-lg px-3 py-2 text-xs text-[var(--text)]"
                                ...
                                <tr key={`${key}-row`}
                                  ...
                                  <td className="px-4 py-2.5">
                                    {syncEnabled !== undefined ? (
                                      <Badge
                                        label={syncLabel}
                                        bg={syncEnabled ? "rgba(74,222,128,.12)" : "rgba(148,163,184,.12)"}
                                        color={syncEnabled ? "#4ade80" : "#94a3b8"}
                                        border={syncEnabled ? "rgba(74,222,128,.25)" : "rgba(148,163,184,.25)"}
                                      />
                                    ) : (
